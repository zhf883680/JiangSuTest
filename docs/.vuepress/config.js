...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'zhf883680/JiangSuTest', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: '周枫', // 必需
      href: 'https://github.com/zhf883680' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:zhf883680@gmail.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/zhf883680'
        }
      ]
    },
    footer:{ // 页脚信息
      createYear: 2021, // 博客创建年份
      copyrightInfo: '周枫 | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  plugins: [ // 插件
